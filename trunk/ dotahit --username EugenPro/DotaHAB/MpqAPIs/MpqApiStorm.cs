...
#pragma warning disable 649
    ...
    {        
        #region dll_import      
        public static bool MpqInitialize() { return true; }

        public static IntPtr MpqOpenArchiveForUpdate(string lpFileName, UInt32 dwFlags, UInt32 dwMaximumFilesInArchive) { return IntPtr.Zero; }
        public static UInt32 MpqCloseUpdatedArchive(IntPtr hMPQ, UInt32 dwUnknown2) { return 0; }
        public static bool MpqAddFileToArchive(IntPtr hMPQ, string lpSourceFileName, string lpDestFileName, UInt32 dwFlags) { return true; }
        public static bool MpqDeleteFile(IntPtr hMPQ, string lpFileName) { return true; }

        // Storm Function Prototypes

        [DllImport("storm",EntryPoint="Open")]
