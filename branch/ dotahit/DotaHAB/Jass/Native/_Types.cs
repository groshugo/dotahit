...
namespace DotaHIT.Jass.Native.Types
{
 ...
 //                   (a as DBINVENTORYABILITY).MetaProps["inv1"] = 20;
        ...
        protected override void LoadIcons()
        {
            ...
            {
                this[iconImage] = DHRC.GetImage(iconName);
                if (iconImage.IsNull)
    ...
    public class timer : handlevalue
    {
        ...
        {
            if (t != null) callback(null, System.Timers.ElapsedEventArgs.Empty as System.Timers.ElapsedEventArgs);
            if (t != null && !periodic) t.Stop();
