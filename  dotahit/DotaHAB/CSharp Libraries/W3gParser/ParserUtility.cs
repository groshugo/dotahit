...
namespace Deerchao.War3Share.W3gParser
{
    internal static class ParserUtility
    {
        ...
        {
            if (DHLOOKUP.hpcAbilityData == null) return ItemType.None;
        ...
        internal static int GetItemStockRegen(string itemID)
        {
            object value = DHLOOKUP.hpcItemData[itemID, "stockRegen"];            
        ...
        {
            return DHLOOKUP.hpcUnitAbilities[heroName].GetStringListValue("heroAbilList");
